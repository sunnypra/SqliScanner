...
from dirbot1.items import Website
...
class step3(Spider):
	...
	main_file = open("dirbot1/spiders/Singleinput.json",'r')
	...
	"""with open('dirbot1/spiders/Singleinput.json') as data_file:
	...
	links = open('dirbot1/spiders/linksToAttack.txt','w')

	with open('dirbot1/spiders/data.json') as data_file:
		data = json.load(data_file)
	...
	links.close()
	links = open('dirbot1/spiders/linksToAttack.txt', 'r')
	...
	def save_original_resp(self, response):
		...
		login = response.request.meta['login']
		newfile = open('dirbot1/linksWithFalsePayloads.txt','a')
	...
	def spider_closed(self, spider):
		fin = dict(dic)
		f = open("dirbot1/spiders/step3output.json", 'w')
